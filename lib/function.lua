...
function KC_Fn.KBLevel(ratio)
  if ratio < .05 then return "|C52FFBFHealer"
  elseif ratio < .2 then return "|C13A600Assistant"
  elseif ratio < .3 then return "|CD97025Killer"
  elseif ratio < .5 then return "|CFF0000Blood Drinker"
  elseif ratio < .8 then return "|C690000Reaper"
  else return "|C1F0000Angel of Death"
  end
end
